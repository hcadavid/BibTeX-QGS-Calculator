    ...
    extends TeiMacroSpecialPara
{
    ...
    protected List<String> targetEnd;
    ...
    /**
     * Gets the value of the targetEnd property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the targetEnd property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTargetEnd().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getTargetEnd() {
        if (targetEnd == null) {
            targetEnd = new ArrayList<String>();
        }
