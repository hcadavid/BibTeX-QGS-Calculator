...
public class SeriesStmt {
    ...
    protected List<Object> idnoOrBiblScope;
    ...
    /**
     * Gets the value of the idnoOrBiblScope property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the idnoOrBiblScope property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIdnoOrBiblScope().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getIdnoOrBiblScope() {
        if (idnoOrBiblScope == null) {
            idnoOrBiblScope = new ArrayList<Object>();
        }
        return this.idnoOrBiblScope;
    }
