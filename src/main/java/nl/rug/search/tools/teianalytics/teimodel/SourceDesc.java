...
public class SourceDesc {
    ...
    protected java.util.List<Object> teiModelPLike;
    @XmlElements({
    ...
    protected java.util.List<Object> biblOrBiblStructOrListBibl;
     ...
     * 
     */
    public java.util.List<Object> getTeiModelPLike() {
    ...
    /**
     * Gets the value of the biblOrBiblStructOrListBibl property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the biblOrBiblStructOrListBibl property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBiblOrBiblStructOrListBibl().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public java.util.List<Object> getBiblOrBiblStructOrListBibl() {
        if (biblOrBiblStructOrListBibl == null) {
            biblOrBiblStructOrListBibl = new ArrayList<Object>();
        }
        return this.biblOrBiblStructOrListBibl;
    }
