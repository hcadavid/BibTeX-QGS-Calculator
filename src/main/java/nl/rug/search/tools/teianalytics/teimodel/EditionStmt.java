...
public class EditionStmt {
    ...
    protected List<Object> teiModelRespLike;
    ...
    /**
     * Gets the value of the teiModelRespLike property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the teiModelRespLike property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTeiModelRespLike().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getTeiModelRespLike() {
        if (teiModelRespLike == null) {
            teiModelRespLike = new ArrayList<Object>();
        }
        return this.teiModelRespLike;
    }
